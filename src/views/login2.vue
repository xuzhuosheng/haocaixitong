	...
	<div class="sjzcpt" id="sjzcpt">
		<!--<header class="s_header">-->
			<!--<div class="s_header_lt">-->
				<!--&lt;!&ndash;<img class="s_header_img1" src="http://hyht-public.oss-cn-shanghai.aliyuncs.com/official-website/static/img/logo_tjfxpt.png"/>&ndash;&gt;-->
        <!--耗材管理系统-->
			<!--</div>-->
			<!--<div class="s_header_rt">-->
				<!--&lt;!&ndash;<img class="s_header_img2" src="http://hyht-public.oss-cn-shanghai.aliyuncs.com/official-website/static/img/login_bz.png"/>&ndash;&gt;-->
				<!--&lt;!&ndash;<span>帮助</span>&ndash;&gt;-->
			<!--</div>-->
		<!--</header>-->
		<section class="s_section" id="s_section">
			...
			<div class="s_section_rt">
				...
				<el-form class="s_login_form" ref="login" :model="login">
					<el-form-item>
						<div class="s_left">
							<img class="s_login_left1"  src="http://hyht-public.oss-cn-shanghai.aliyuncs.com/official-website/static/img/login_yonghu.png"/>
					...
					<el-form-item>
						<div class="s_right">
							<img class="s_login_left1" src="http://hyht-public.oss-cn-shanghai.aliyuncs.com/official-website/static/img/login_mima.png"/>
		...
		<footer class="s_footer">
			...
			<div class="s_footer_rt">
				<img class="s_footer_img" src="http://hyht-public.oss-cn-shanghai.aliyuncs.com/official-website/static/img/login_iphone.png"/>
